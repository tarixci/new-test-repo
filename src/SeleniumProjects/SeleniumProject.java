...
public class SeleniumProject {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.name("username")).sendKeys((faker.name().username()), Keys.ENTER);
        driver.findElement(By.name("firstName")).sendKeys((faker.name().firstName()), Keys.ENTER);
        driver.findElement(By.name("lastName")).sendKeys((faker.name().lastName()), Keys.ENTER);

        driver.findElement(By.name("email")).sendKeys(((faker.internet().emailAddress())));
        driver.findElement(By.name("email")).getText();
        Thread.sleep(1000);

        driver.findElement(By.name("email2")).sendKeys(driver.findElement(By.name("email")).getText(), Keys.ENTER);
